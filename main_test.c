...
/*   Updated: 2017/08/17 19:26:51 by esterna          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    ...
    *p=5;
	...
	ft_printf("%.*d\n", 5, 42);
*/
	ft_printf("%aKashim a %a histoires à raconterIl fait au moins %a\n%13a%a%a%a\n%%a %7a == |%a|\n%%a 	 == |%a|\n%%a Lydie == |%a|\n%%a 42.42 == |%a|\n%AKashim a %A histoires à raconterIl fait au moins %A\n%A%A%A%A%%A %A == |%A|\n%%A 	 == |%A|\n%%A Lydie == |%A|\n%%A 42.42 == |%A|\n%%A 42.42 == |%A|\n", 42.0, 1001.0, -8000.0, 2147480000.0, -2147480000.0, -2.14748e+09, 2.14748e+09, 42.0, 34.0, 9.0, 503.0, 42.42, 42.0, 1001.0, -8000.0, 2147480000.0, -2147480000.0, -2.14748e+09, 2.14748e+09, 42.0, 34.0, 9.0, 503.0, 42.42);
